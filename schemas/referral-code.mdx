...
- 5-tier progression system (Bronze → Silver → Gold → Platinum → Diamond)
- Reward multipliers increase with tier (1.0x → 3.0x)
...
|------|--------------|------------|--------------|-------|----------|
| 🥉 Bronze | 0 | 1.0x | Base | Bronze | Base platform benefits |
| 🥈 Silver | 5 | 1.2x | +20% | Silver | Priority support |
| 🥇 Gold | 15 | 1.5x | +50% | Gold | Early feature access |
| 💎 Platinum | 30 | 2.0x | 2x | Platinum | VIP support, featured profile |
| 💎✨ Diamond | 50+ | 3.0x | 3x | Diamond | Direct team access, partnership opportunities |
...
```typescript
const TIER_CONFIGS = [
  { tier: 'bronze', minReferrals: 0, multiplier: 1.0, badge: '🥉' },
  { tier: 'silver', minReferrals: 5, multiplier: 1.2, badge: '🥈' },
  { tier: 'gold', minReferrals: 15, multiplier: 1.5, badge: '🥇' },
  { tier: 'platinum', minReferrals: 30, multiplier: 2.0, badge: '💎' },
  { tier: 'diamond', minReferrals: 50, multiplier: 3.0, badge: '💎✨' },
]
```
...
// Examples:
// john.doe@example.com → johndoe7abc
// jane_smith123@company.com → janesmith4xyz
```
